...
alias arm='taskset -c 1-4 ros2 launch franka_fr3_moveit_config moveit.launch.py robot_ip:=192.168.1.11'
alias human_demo='taskset -c 5-8 ros2 run lfd_apples lfd_data_collection'
alias gripper='taskset -c 5-8 ros2 launch lfd_apples lfd_gripper.launch.py palm_camera_device_num:=6 fixed_camera_device_num:=4'
alias sensors='ros2 topic echo /microROS/sensor_data'
alias lfd_layout='terminator -l lfd_trials'

alias robot='taskset -c 9-12 ros2 run lfd_apples lfd_implementation'
