...
alias arm='taskset -c 1,2,3,4,5 ros2 launch franka_fr3_moveit_config moveit.launch.py robot_ip:=192.168.1.11'
alias human_demo='taskset -c 6,7,8 ros2 run lfd_apples lfd_data_collection'
